...
from analysis_ensembles import plot_loss_ensembles_vs_single
plot_loss_ensembles_vs_single(*list(ensemble_prmts.values()), results)
plot_loss_ensembles_vs_single(*list(ensemble_prmts.values()), results, print_individuals=True)
plot_loss_ensembles_vs_single(*list(ensemble_prmts.values()), results, print_individuals=False, results_=results_)

        
from analysis_ensembles import plot_accuracy_ensembles_vs_single
plot_accuracy_ensembles_vs_single(*list(ensemble_prmts.values()), results)
plot_accuracy_ensembles_vs_single(*list(ensemble_prmts.values()), results, print_individuals=True)
plot_accuracy_ensembles_vs_single(*list(ensemble_prmts.values()), results, print_individuals=False, results_=results_)
