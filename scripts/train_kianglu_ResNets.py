...
parser.add_argument('--experiment', '-x', default=1, type=int, help='resnet experiment')
...
if exp == 1:
    K = 5
    exp = 'ResNet152 vs ResNet18(x5)'
elif exp == 2:
    K = 3
    expt = 'ResNet101 vs ResNet34(x2)'


# Paths to Results
check_path = './checkpoint/{}.t7'.format(exp)
path = '../results/dicts/{}.pkl'.format(exp)
